...
const connectRabbitMQ = async () => {
  ...
  await channel.assertQueue(config.rabbitmq.push_queue, {
    durable: true,
  ...
  await channel.bindQueue(config.rabbitmq.push_queue, config.rabbitmq.exchange, config.rabbitmq.push_queue);
